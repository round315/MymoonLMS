                                ...
                                @foreach($vip as $content)
                                    @if(isset($content->content->id))
                                        ...
                                        <div class="col-md-3 col-sm-6 col-xs-12 pagi-content vip-content tab-con">
                                            <a href="<?=$base_url?>/product/{{ $content->content->id }}" title="{{ $content->content->title }}" class="content-box pagi-content-box">
                            ...
                            @foreach($contents as $content)
                                @if(!in_array($content['id'],$vipIds))
                                    <div class="col-md-3 col-sm-6 col-xs-12 pagi-content tab-con">
                                        <a href="<?=$base_url?>/product/{{ $content['id'] }}" title="{{ $content['title'] }}" class="content-box pagi-content-box">

                                            <div class="img-container">
                                                <img src="<?=$base_url?>{{ !empty($content['metas']['cover']) ? $content['metas']['cover'] : '' }}"/>
                            ...
                            @if(isset($ads))
                                @foreach($ads as $ad)
                                    @if($ad->position == 'category-pagination-bottom')
                                        <a href="<?=$base_url?>{{ $ad->url }}"><img src="{{ $ad->image }}" class="{{ $ad->size }}" id="cat-side"></a>
                                    @endif
                                @endforeach
                            @endif
                        </div>

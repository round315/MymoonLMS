                ...
                @foreach($lists as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            @if(!empty($item->user))
                                <a title="{{ $item->user->name }}" href="/profile/{{ $item->user->id }}">{{ $item->user->name }}</a>
                            @endif
                        </td>
                        <td class="text-center">
                            @if(!empty($item->users))
                        ...
                        <td class="text-center" width="50">
                            <a href="/admin/user/item/{{ $item->user->id }}" title="Upgrade teacher"><i class="fa fa-user-check" aria-hidden="true"></i></a>
